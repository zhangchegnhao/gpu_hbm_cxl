...
from sieve_replay.ramulator.contention_table_builder import build_contention_table  # noqa: E402


def main() -> int:
    parser = argparse.ArgumentParser(
        description="Generate a strict Sieve cycle-v1 GPU/PIM contention table"
    )
